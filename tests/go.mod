...
require (
	...
	github.com/roadrunner-server/app-logger/v5 v5.1.9 // indirect
	...
	github.com/roadrunner-server/grpc/v5 v5.3.0 // indirect
	github.com/roadrunner-server/gzip/v5 v5.3.0 // indirect
	github.com/roadrunner-server/headers/v5 v5.2.0 // indirect
	github.com/roadrunner-server/http/v5 v5.3.0 // indirect
	github.com/roadrunner-server/informer/v5 v5.1.9 // indirect
	github.com/roadrunner-server/jobs/v5 v5.1.9 // indirect
	...
	github.com/roadrunner-server/metrics/v5 v5.2.0 // indirect
	github.com/roadrunner-server/nats/v5 v5.1.9 // indirect
	github.com/roadrunner-server/otel/v5 v5.6.0 // indirect
	...
	github.com/roadrunner-server/prometheus/v5 v5.2.0 // indirect
	...
	github.com/roadrunner-server/rpc/v5 v5.1.9 // indirect
	github.com/roadrunner-server/send/v5 v5.2.0 // indirect
	github.com/roadrunner-server/server/v5 v5.2.10 // indirect
	github.com/roadrunner-server/service/v5 v5.1.9 // indirect
	github.com/roadrunner-server/sqs/v5 v5.1.9 // indirect
	github.com/roadrunner-server/static/v5 v5.2.0 // indirect
	...
	github.com/temporalio/roadrunner-temporal/v5 v5.11.0 // indirect
