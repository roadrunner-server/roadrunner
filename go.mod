...
require (
	...
	github.com/roadrunner-server/beanstalk/v4 v4.6.0
	...
	github.com/temporalio/roadrunner-temporal/v4 v4.5.6
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/sqs v1.29.4 // indirect
